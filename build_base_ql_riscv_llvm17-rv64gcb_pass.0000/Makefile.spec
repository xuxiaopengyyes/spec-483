...
CXXOPTIMIZE      = -std=c++11 -O3 -ffast-math -march=rv64gc_zba_zbb_zbc_zbs -flto -ffp-contract=off -Wno-compound-token-split-by-macro -Wno-c++11-narrowing -static -w -fprofile-use=train.profdata

TUNE=base
EXT=ql_riscv_llvm17-rv64gcb_pass
NUMBER=483
NAME=xalancbmk
...
CXXOPTIMIZE      = -std=c++11 -O3 -ffast-math -march=rv64gc_zba_zbb_zbc_zbs -flto -ffp-contract=off -Wno-compound-token-split-by-macro -Wno-c++11-narrowing -static -w -fprofile-use=merged.profdata
...
commandexe       = Xalan_base.ql_riscv_llvm17-rv64gcb_pass
...
compwhite        = 
configdir        = config
configpath       = /home/xzp/speccpu2006-v1.0.1/config/riscv_llvm17-rv64gcb_pass.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log              = CPU2006
log_line_width   = 0
logname          = /home/xzp/speccpu2006-v1.0.1/result/CPU2006.157.log
lognum           = 157
mach             = default
mail_reports     = all
mailcompress     = 0
...
review           = 0
run              = all
runspec          = /home/xzp/speccpu2006-v1.0.1/bin/runspec --config=riscv_llvm17-rv64gcb_pass.cfg --size=ref --noreportable --tune=base --iterations=3 --speed --action=setup 483
safe_eval        = 1

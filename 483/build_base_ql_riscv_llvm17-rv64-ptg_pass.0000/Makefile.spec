TUNE=base
EXT=ql_riscv_llvm17-rv64-ptg_pass
NUMBER=483
NAME=xalancbmk
...
COPTIMIZE        = -Wno-int-conversion -O3 -ffast-math -march=rv64gc -flto -ffp-contract=off  -Wno-compound-token-split-by-macro  -static
...
CXXOPTIMIZE      = -std=c++98 -O3 -ffast-math -march=rv64gc -flto -ffp-contract=off -Wno-compound-token-split-by-macro -w -static -Wno-c++11-narrowing
...
commandexe       = Xalan_base.ql_riscv_llvm17-rv64-ptg_pass
...
compwhite        = 
configdir        = config
configpath       = /home/xzp/speccpu2006-v1.0.1/config/riscv_llvm17-rv64-ptg_pass.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log              = CPU2006
log_line_width   = 0
logname          = /home/xzp/speccpu2006-v1.0.1/result/CPU2006.156.log
lognum           = 156
mach             = default
mail_reports     = all
mailcompress     = 0
...
review           = 0
run              = all
runspec          = /home/xzp/speccpu2006-v1.0.1/bin/runspec --config=riscv_llvm17-rv64-ptg_pass.cfg --size=ref --noreportable --tune=base --iterations=3 --speed --action=setup 483
safe_eval        = 1
